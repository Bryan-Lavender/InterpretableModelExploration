...
from wrappers import video_recorder
...
class RecordVideo(gym.Wrapper):
    ...
    def step(self, action):
        ...
        if results is not None:
            ...
            observations, rewards, terminateds, truncateds, infos = (None, None, None, None, None)
        ...
        if not (self.terminated or self.truncated):
            ...
            elif terminateds and terminateds[0] or truncateds and truncateds[0]:
                self.episode_id += 1
